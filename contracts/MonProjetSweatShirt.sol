...
contract MonProjetSweatShirt is ERC1155, Ownable {
    ...
    uint256 private priceOfMint = 0.05 ether; // Prix en ether pour pouvoir mint un NFT.
    ...
    function mint() public payable {
        require(msg.value >= priceOfMint, "Insufficient payment");
    ...
    function burn() public {
        require(ownedTokens[msg.sender].length > 0, "You don't own any tokens");
